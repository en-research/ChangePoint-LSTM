...
## Evaluation ##
# Use clip(upper=130) if following existing benchmarks such as https://www.sciencedirect.com/science/article/pii/S0951832021004439?via%3Dihub (for discussion refer to our change point paper)
# Alternatively, clip can be removed to evaluate the model without upper RUL limit
